          ...
          {!isDriverSection && (
            <>
              ...
              {isSignedIn && (
                <Link
                  href="/wishlist"
                  className={`p-2 text-slate-700 hover:text-rose-500 transition-colors rounded-full hover:bg-rose-50/60 ${
                    currentPath.startsWith('/wishlist') ? 'text-rose-500 bg-rose-50/80' : ''
                  }`}
