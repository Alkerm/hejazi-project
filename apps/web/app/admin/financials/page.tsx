                          ...
                          {isModified ? (
                            <>
                              <button
                                ...
                                title={t('Save price changes', 'حفظ التعديلات')}
                                className="flex items-center gap-1 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-[11px] px-2.5 py-1 rounded-lg shadow-xs transition cursor-pointer"
                              >
                                <Check className="w-3 h-3" />
                                <span>{isSavingThis ? '...' : t('Save', 'حفظ')}</span>
                              </button>

                              <button
                                onClick={() => handleResetProduct(product)}
                                title={t('Reset changes', 'تراجع')}
                            ...
                            <Link
                              ...
                              className="inline-flex items-center gap-1 text-[11px] font-bold text-slate-500 hover:text-amber-600 p-1.5 rounded-lg hover:bg-slate-100 transition"
                              title={t('Full product edit', 'تعديل كامل بيانات المنتج')}
                            >
